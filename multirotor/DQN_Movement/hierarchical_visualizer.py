...
class HierarchicalVisualizer:
    ...
    def draw_leader(self):
        ...
        try:
            ...
            # 绘制Leader
            pygame.draw.circle(self.screen, self.LIGHT_BLUE, screen_pos, 25)
            pygame.draw.circle(self.screen, self.WHITE, screen_pos, 25, 3)
            
            # 绘制扫描范围
            radius_pixels = int(radius * self.scale)
            pygame.draw.circle(self.screen, self.LIGHT_BLUE, screen_pos, radius_pixels, 3)
